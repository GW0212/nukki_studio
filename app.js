...
(() => {
  ...
  let touchDownAt = 0;
  let touchDrawAllowedAt = 0; // block drawing briefly to avoid 2-finger tap race creating a short stroke
 // px in device pixels (after DPR)
  ...
  function updateZoomLabel(){
    ...
    // When internal zoom is 1, allow browser double-tap to zoom OUT the page.
    // When zoomed in, block browser gestures so our pan/zoom stays stable.
    if (view) { view.style.touchAction = (zoom <= 1.0) ? "manipulation" : "none"; }
  }
